    ...
    <>
      <section class="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
        <div class="mx-auto max-w-screen-xl px-4 2xl:px-0">
          {/* <!-- Heading & Filters --> */}
          <div class="mb-6 space-y-4 sm:flex sm:space-y-0 text-center w-[100%]">
            <h2 class="mt-3 text-xl  font-semibold text-gray-900 dark:text-white w-[100%] sm:text-2xl">Electronics</h2>
          </div>
          <div class="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">

            {
              products.map((v,i) => {
                return (
                  <div class="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800" key={i}>
                    <div class="h-56 w-full">
                      <a href="#">
                        <img class="mx-auto h-full dark:hidden" src={v.image} alt="" />
                        <img class="mx-auto hidden h-full dark:block" src={v.image} alt="" />
                      </a>
                    </div>
                    <div class="pt-6">
                      ...
                      <a href="#" class="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">{v.name}</a>
                      ...
                      <div class="mt-4 flex items-center justify-between gap-4">
                        <p class="text-2xl font-extrabold leading-tight text-gray-900 dark:text-white">${v.price}</p>
...

          {
            ...
            <div class="w-full text-center">
              <button type="button" onClick={ showMore } class="rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Show more</button>
            </div>
            :
            ''
